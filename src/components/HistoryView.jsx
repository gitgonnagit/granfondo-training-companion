            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {entry.anyFlag && (
                    <span
                      title={`Triggered: ${entry.triggeredIds.join(', ')}`}
                      className="inline-flex items-center rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-red-800 ring-1 ring-red-300"
                    >
                      ⚑ Flag
                    </span>
                  )}
